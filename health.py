...
model_path = r"C:\Users\nagal\Downloads\project-H\healths_model_updated.h5"  # Ensure this file exists in the same directory or provide the full path
try:
...
def predict_image(image_path, model):
    ...
    try:
        ...
        return "Parkison" if prediction[0][0] >= 0.1 else "Normal"
    except Exception as e:
